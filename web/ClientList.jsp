        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <center>
                    <h1>Clients</h1>
                    <h2>
                        <a href="/client/new">Add New Client</a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="/client/list">List All Clients</a>
                    </h2>
                </center>
                <div id="container">
                    ...
                    <table class="table table-striped" id="info-table">
                        ...
                        <c:forEach var="client" items="${clientList}">
                            <tr>
                                ...
                                <td>
                                    <a href="/client/edit?id_client=<c:out value='${client.id_client}' />">Edit</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="/client/delete?id_client=<c:out value='${client.id_client}' />" class="btn btn-sm btn-outline-danger">X</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
